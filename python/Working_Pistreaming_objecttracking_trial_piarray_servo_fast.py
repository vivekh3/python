    ...
    with picamera.PiCamera() as camera:
        ...
        while (True):
            with picamera.array.PiRGBArray(camera) as stream:
                ...
                print("x :"+str(int(x))+", y :"+str(int(y))+", delta-x :"+ str(delx)+", delta-y :"+str(dely)+", Y-Angle:"+str(mangley)+", dirxn:"+str(dirxny))
                ...
                if (mangley>10 and (dely>5 or dely<-5)):
                    mangley=int((0.25)*abs(dely))
                    move_servo(8,mangley+init_angley)
                    print("Angle - y: "+str(mangley))
...
#                    if(mangley>10):
#                        move_servo(8,mangley+init_angley)
#                        print(mangley+init_angley)
#                    elif (mangley<10):
#                        if (dely>5):
#                            dirxny=-1
#                            mangley=mangley+dirxny*step
#                    
#                            move_servo(8,mangley+init_angley)
#                        elif (dely<-5):
#                            dirxny=1
...
#                            move_servo(8,mangley+init_angley)
                ...
                #    move_servo(0,canglex)
                    ...
                    print ("delta-y: "+str(dely)+"mangle-y: "+str(mangley))
                    break
